...
preferences {
	tiles {
		...
		main(["switch"])
		details(["switch", /*"lastOn", "lastOff"*/ "power", "refresh"])
	}
}
...
def poll() {
	...
	//def power = Math.round(device.currentValue("power"))
//log.debug "Power is ${power}"
	...
	//sendEvent(name:"power", value:"${power}", isStateChange:true, displayed:false)
}
